...
public class TestContainer {
    ...
    public TestContainer(BeansXml beansXml, Collection<Class<?>> classes) {
        this(new FlatDeployment(new BeanDeploymentArchiveImpl(beansXml, classes, Environments.SE), Environments.SE));
    }
    ...
    public TestContainer(BeansXml beansXml, Class<?>... classes) {
        this(new FlatDeployment(new BeanDeploymentArchiveImpl(beansXml, asList(classes), Environments.SE), Environments.SE));
    }

    public TestContainer(Class<?>... classes) {
        this(new FlatDeployment(new BeanDeploymentArchiveImpl(asList(classes), Environments.SE), Environments.SE));
    }
